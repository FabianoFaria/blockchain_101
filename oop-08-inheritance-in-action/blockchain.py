...
class Blockchain:
    def __init__(self, public_key, node_id):
        ...
        #Iniciando nossa (vazia) lista de blockchain
    ...
    def get_balance(self, sender = None):
        ...
        open_tx_sender = [tx.amount
                        for tx in self.get_open_transactions() if tx.sender == participant]
    ...
    def add_peer_node(self, node):
        """
            Adiciona um novo node ao conjuto de node par.
        """
    ...
    def remove_peer_node(self, node):
        """
            Remove um novo node ao conjuto de node par.
        """
        self.__peer_nodes.discard(node)

    def get_peer_nodes(self):
        """
            Retornar uma lista com todos os pares de nós conectados...
        """
